...
racket1 = Player('nazar.png', 30, 200, 4, 50, 150) 
racket2 = Player('vasa.png', 520, 200, 4, 50, 150)
ball = GameSprite('apple.png', 200, 200, 4, 50, 50)
...
while game:
    ...
    if finish != True:
        ...
        if ball.rect.x < 0 and score_1 < 3:
            ...
            window.blit(font.render(str(score_1), True, (250, 50, 50)), (450, 40))
        ...
        if ball.rect.x > win_width and score_2 < 3:
            ...
            window.blit(font.render(str(score_2), True, (250, 50, 50)), (200, 40))
        ...
        if score_1 == 3:
            ...
            window.blit(font.render("Рахунок ДРУГОГО гравця - " , True, (250, 50, 50)), (80, 40))
        ...
        if score_2 == 3:
            ...
            window.blit(win1, (200, 100))
            window.blit(font.render("   - це рахунок ПЕРШОГО гравця ", True, (250, 50, 50)), (200, 40))
